...
export const Expert = ({ navigation }) => {
  const [param1, setParam1] = useState(Math.floor(Math.random() * 10000))
  const [param2, setParam2] = useState(Math.floor(Math.random() * 10000))
  const [param3, setParam3] = useState(Math.floor(Math.random() * 10000))
